 ...
 * Using ApplicationReadyEvent ensures all beans (including MongoDB connections) are ready.
 */
@Slf4j
@Component
...
public class KafkaConsumerLifecycle {
    ...
    public void onApplicationReady() {
        log.info("Starting Kafka consumers for ms-notifications (order-events, inventory-events)");
