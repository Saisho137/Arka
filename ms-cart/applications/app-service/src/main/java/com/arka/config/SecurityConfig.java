    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchanges -> exchanges
                        ...
                        .pathMatchers(HttpMethod.GET, "/api/v1/cart/**").hasAnyRole("ADMIN", "CUSTOMER")
                        .pathMatchers(HttpMethod.POST, "/api/v1/cart/**").hasAnyRole("ADMIN", "CUSTOMER")
                        .pathMatchers(HttpMethod.PUT, "/api/v1/cart/**").hasAnyRole("ADMIN", "CUSTOMER")
                        .pathMatchers(HttpMethod.DELETE, "/api/v1/cart/**").hasAnyRole("ADMIN", "CUSTOMER")
